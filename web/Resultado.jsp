<%-- 
    Document   : Resultado
    Created on : 30/05/2022, 10:43:31 AM
    Author     : Andre
--%>
...
<html lang="en">
    ...
    <body>
        <div class="d-flex" id="wrapper">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-dark fw-bold h4 text-center">
                  <i class="text-primary">Asesoria Juridica </i><i class="text-warning">Reserplace <i class="fa-solid fa-book"></i></i> 
             ...
             <seccion>
                    <div class="container-fluid mt-1">
                        <div class="row">
                             <%
                                      ArrayList<Abogado> lis=(ArrayList<Abogado>)request.getAttribute("z");
                                      int salto=0;
                                      for (Abogado p:lis){
                                      %>
                            <div class="col-sm-3">
                                <div class="card">                                   
                                    ...
                                    <div class="card-footer text-center list-group-item-warning" >
                                        <label class="text-dark fw-bold"><%=p.getNomA()%> </label><br>
                                        <label class=""><%=p.getEsp()%> </label>
                                         <div>  
                                         <a href="perfilAbo.jsp?id=<%=p.getCod()%>" class="btn btn-success btn-sm active " role="button">Ver Perfil Abogado</a>
                                         </div>
                                    </div>
                                </div>
                            </div>
