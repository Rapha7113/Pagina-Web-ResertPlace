...
<html lang="en">
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-dark border-bottom">
               ...
               <div class="container-fluid">
                  <p class="h4 text-success fw-bold"> Solicitar Reservación <i class="fa-solid fa-clock"></i></p> 
  ...
  <div class="col-md-6 ">
    ...
    <%
    Abogado x=DaoAbogado.Datos(Integer.parseInt(request.getParameter("cod")));
    %>
    <input type="hidden" value="<%=x.getCod()%>" name="txtAbog">
    <input type="text" class="form-control border border-secondary" id="validationDefault02" value="<%=x.getNomA()%>" readonly>
  </div>
 ...
 <a href="ServletContAbo?opcion=nombres" class="btn btn-danger btn-block w-100 fw-bold">Cancelar</a>
 </div>
