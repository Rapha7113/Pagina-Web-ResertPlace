    ...
    <body>
        <div class="d-flex" id="wrapper">
          ...
          <div class="container-fluid ">               
                ...
                <i class="text-center text-primary fw-bold h4">Mis Reservaciones -</i> <i class="text-success fw-bold h5">Asesoria Legal Reserplace</i>
                <hr class="line" size="5px">                     
               <seccion>
               <div class="container-fluid">
                <div class="col-lg-12">
                    ...
                    <table class="table table-hover table-bordered wd-100" id="datatable" class="display">
                                    <thead >
                                        <tr class="text-light bg-warning">                                            
                                            <th class="text-center">Cliente Reservacion</th>
                                            <th class="text-center">Abogado Asesor</th>
                                            <th class="text-center">Modalidad Reserv.</th>
                                         ...
                                         <%
                        ArrayList<Reserva> lista=(ArrayList<Reserva>)request.getAttribute("ci");
