<%-- 
    Document   : Lista_Abogado
    Created on : 31/05/2022, 12:23:55 AM
    Author     : Andre
--%>
...
<html lang="en">
    <head>
        ...
        <script src="jcs/scripts.js"></script>
    ...
    <body>
        <div class="d-flex" id="wrapper">
          ...
          <div class="container-fluid">                    
                ...
                <i class="text-center text-danger fw-bold h4">Lista de Abogados Reserplace</i>
                <hr size="5px" color="black">
           <seccion>
               <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="table-responsive">
             <table  class="table table-striped table-bordered wd-100" id="datatable">
                <thead>
                    <tr class="bg-primary text-light">
                     <th class="text-center">Codigo Abogado</th>
                     <th class="text-center">Nombre Apellido Abogado</th>
              ...
              <tbody>
                                <%
                        ArrayList<Abogado> lista=(ArrayList<Abogado>)request.getAttribute("m");
                        for(int i=0; i<lista.size();i++)
                        {
                            Abogado em=lista.get(i);    
                       %>
                        <tr>
                            <td class="text-center"><%=em.getCod()%></td>
                            <td class="text-center"><%=em.getNomA()%></td>
                            <td class="text-center"><%=em.getEsp()%></td>
                            <td class="text-center"><%=em.getGrado()%></td>
                       <%}%>    
            </tbody>
