...
<html lang="en">
    ...
    <body>
        <div class="d-flex" id="wrapper">
          ...
          <div class="container-fluid ">               
                <div class="col-md-12 mt-2 text-center text-success ">
                <i class="text-center text-danger fw-bold h4">Mantenimiento Abogado</i>
                    ...
                    <table class="table table-striped table-bordered wd-100" id="datatable" class="display">
                                    <thead >
                                        <tr class="text-light bg-success">
                                            ...
                                            <th class="text-center">Nombre Abogado</th>
                                            <th class="text-center">Especialidad</th>
                                            <th class="text-center">Exp. Laboral</th>
                                            <th class="text-center">Grado Acad.</th>
                                         ...
                                         <%
                        ArrayList<Abogado> lista=(ArrayList<Abogado>)request.getAttribute("Abog");
                        for(int i=0; i<lista.size();i++)
                        {
                            Abogado em=lista.get(i);    
                       %>
                        <tr>
                            <td><%=em.getCod()%></td>
                            <td><%=em.getNomA()%></td>
                            ...
                            <td>
                             <div class="" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="btn-group mr-2" role="group" aria-label="Basic example">
                                            ...
                                            <div class="modal fade" id="modalEditar<%=i%>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form method="post" action="ServletContAbo?ope=editar&idA=<%=em.getCod()%>">
                                                            
                                                            <!-- Titulo del modal -->
                                                            <div class="modal-header bg-primary">
                                                            <h5 class="modal-title text-light" id="staticBackdropLabel">Actualizar Abogado </h5>
                                                            ...
                                                            <!-- Cuerpo del modal-->
                                                                ...
                                                                <div class="mb-2 col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="" name="txtNA" value="<%=em.getNomA()%>">
                                                                </div>
                                                                <div class="mb-2 col-md-6">
                                                                    <label for="" class="form-label fw-bold">Especialidad</label>
                                                                    <input type="text" class="form-control" id="" name="txtESA" value="<%=em.getEsp()%>">
                                                                </div>
                                                                
                                                                <div class="mb-2 col-md-6">
                                                                    <label for="" class="form-label fw-bold">Experiencia Laboral</label>
                                                                    <input type="text" class="form-control" id="" name="txtEA" value="<%=em.getExp()%>">
                                                                </div>
                                                                <div class="mb-2 col-md-6">
                                                                    <label for="" class="form-label fw-bold">Grado Academico</label>
                                                                    <input type="text" class="form-control" id="" name="txtGA" value="<%=em.getGrado()%>">
                                                                </div>
                                                                <div class="mb-2 col-md-6">
                                                                    <label for="" class="form-label fw-bold">Telefono</label>
                                                                    <input type="text" class="form-control" id="" name="txtTA" value="<%=em.getTelf()%>">
                                                                </div>
                                                                <div class="mb-2 col-md-6">
                                                                    <label for="" class="form-label fw-bold">Correo Electronico</label>
                                                                    <input type="text" class="form-control" id="" name="txtCA" value="<%=em.getCorreo()%>">
                                                                </div>
                                                                <!-- Editar Categoria -->
                                            ...
                                            <a onclick="return confirm('¿Esta seguro de eliminar este registro?')" href="ServletContAbo?opcion=eliminar&idA=<%=em.getCod()%>" class="btn btn-danger link-light" style="text-decoration: none">Eliminar</a>
                                        </div>                           
                                    </div>
                                </td>   
