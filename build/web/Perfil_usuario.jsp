        ...
        <div class="d-flex" id="wrapper">
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="Perfil_usuario">Perfil</a>
          ...
          <div class="container-fluid">              
              <div class="col-md-12 mt-1 text-center text-primary fw-bold h4">
                  <i>Perfil Usuario</i>&nbsp;<i class="fa-regular fa-user"></i> 
              </div>
              <hr class="line" size="5px" color="black">     
                ...
                <div class="row">
                            <div class="col-sm-3">
                                <div class="card">  
                                    <form  action="ServletCliente?ope=editar&idUs=<%=cod%>" method="post" > 
                                    <div class="card-body">
        <table border="0" width="700" align="center" class="">
                <tr>
                    <th rowspan="9"><img src="imagenes/User.png" width=210 height="190" class=""></th>
                    <th> Nombre y Apellido :</th>
                    <th> <input type="text" name="txtU" value="<%=usuario%>"  class="form-control border-1"></th>
                </tr><tr><th>Genero:</th>
                     <th><input type="text" name="txtG" value="<%=genero%>"  class="form-control border-1"></th>
                </tr><tr><th>Correo Electronico:</th>
                    <th><input type="text" name="txtC" value="<%=correo%>"  class="form-control border-1"></th>
                </tr><tr><th> Password:</th>
                    <th>                       
          <div class="input-group-append">
            <input ID="txtPassword" name="txtP" type="Password" Class="form-control border-1" value="<%=password%>" >
            <button id="show_password" class="btn btn-primary" type="button" onclick="mostrarPassword()"> <span class="fa fa-eye-slash icon"></span> </button>
                                    ...
                                    <div class="card-footer text-center bg-light" >
                                         <div>
                                          <button type="submit" id="" name="" value="registrar" class="btn btn-success">Actualizar Datos</button>
                                         </div>
                                    </div>
                 </form>  
                                </div>
